...
GTD <- subset(rawGTD, select = c(eventid, iyear, imonth, iday, country, region, attacktype1, targtype1, targsubtype1, propextent, nkill, nwound),iyear >= 1970 & success == 1, na.strings = c("", " "))
...
TUPforPlot <- recode(TUPforPlot, "1 = '0 - Military and Farmland'; 2 = '2 - Local Governanceand Police'; 3 = '5 - Potentially Urban Workplace'; 4 = '7 - Potentially Urban Infrastructure'; 5= '9 - Potentially Expressions of Urban Life'", as.numeric.result=FALSE)
